...
# The name of the job:
#SBATCH --job-name="few-shot-6.7b-instruct-codereview"
...
#SBATCH -o logs/few-shot-6.7b-instruct-codereview.log
...
python code_review_instruction_few_shot.py \
    ...
    --conf_path ../config/deepseek-coder-few-shot-6.7b-instruct-codereview.json \
