...
# The name of the job:
#SBATCH --job-name="72b-instruct-few-shot"
...
#SBATCH -e logs/72b-instruct-few-shot-%N.%j.err # STDERR
...
python code_review_instruction_parallel.py \
    --ckpt_dir ./ckpt/Qwen2.5-72B-Instruct \
    --tokenizer_path ./ckpt/Qwen2.5-72B-Instruct \
    --conf_path ../config/few-shot-dl/qwen2.5-72B-instruct-cr-faiss-3.json \
    --temperature 0.0 --top_p 0.95 \
    --max_new_tokens 2048 \
    --tp_size 4 \
    --debug False
...
python code_review_instruction_parallel.py \
    --ckpt_dir ./ckpt/Qwen2.5-72B-Instruct \
    --tokenizer_path ./ckpt/Qwen2.5-72B-Instruct \
    --conf_path ../config/few-shot-dl/qwen2.5-72B-instruct-crn-faiss-3.json \
    --temperature 0.0 --top_p 0.95 \
    --max_new_tokens 2048 \
    --tp_size 4 \
    --debug False
