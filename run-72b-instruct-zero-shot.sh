...
# The name of the job:
#SBATCH --job-name="72b-instruct-zero-shot"
...
#SBATCH -o logs/72b-instruct-zero-shot-%N.%j.out # STDOUT
#SBATCH -e logs/72b-instruct-zero-shot-%N.%j.err # STDERR
...
python code_review_instruction_parallel.py \
    ...
    --conf_path ../config/zero-shot/qwen2.5-72B-instruct-cr.json \
...
python code_review_instruction_parallel.py \
    --ckpt_dir ./ckpt/Qwen2.5-72B-Instruct \
    --tokenizer_path ./ckpt/Qwen2.5-72B-Instruct \
    --conf_path ../config/zero-shot/qwen2.5-72B-instruct-crn.json \
    --temperature 0.0 --top_p 0.95 \
    --max_new_tokens 512 \
    --tp_size 4 \
    --debug False
